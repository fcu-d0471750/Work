...
public class Placeyesno7 : MonoBehaviour {
	...
	void Start () {
		...
		//讀檔
		//Placetime  =  PlayerPrefs.GetInt("Placetime7"); //讀入成就記錄(以下相同)

		if(Placetime!=70) yes = true;  //如果Placetime!=20表示已經按下確定所以yes = true
	}
	...
	void Update () {
		...
		//
		//記錄*****************************************************************************************
		//PlayerPrefs.SetInt("Placetime7", Placetime );
