...
public class Award2 : MonoBehaviour {
...
//====================================================
	...
	void Start () {
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 5000)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 9999)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelMistakesum >= 5)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelMistakesum >= 50)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelMistakesum >= 500)  //達到目標
		{
