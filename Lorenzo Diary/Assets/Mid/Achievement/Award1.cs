...
public class Award1 : MonoBehaviour {
	...
	public static int[] Get = new int[20];   //是否獲得過獎杯 0:沒獲得 1:已獲得
//====================================================
	...
	void Start () {
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 1)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 50)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 500)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 1000)  //達到目標
		{
		...
		//**************************************************
		if (AllScore.LevelCorrectsum >= 3000)  //達到目標
		{
